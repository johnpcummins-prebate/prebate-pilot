...
# Resolve project root relative to THIS file so assets load correctly even if app is in a subfolder
APP_DIR = Path(__file__).parent.resolve()
ASSETS_DIR = APP_DIR / "assets"
LOGO_PATH = ASSETS_DIR / "prebate_logo.png"
...
try:
    ...
    st.warning(f"Logo not found at {LOGO_PATH}. You can replace it with your own logo.")
...
if st.session_state.completed:
    ...
    # PDF (use resolved absolute path for logo)
    def build_pdf():
        buffer = BytesIO()
