...
st.set_page_config(page_title="PreBate – Estate Readiness Pilot", page_icon="🧾", layout="centered", initial_sidebar_state="collapsed")
...
.hero p { color: #111827; max-width: 780px; margin: 0 auto 0.5rem; font-size: 1.05rem; }
...
def render_logo_centered():
    ...
    st.markdown("""
        <div style="text-align:center;margin:0.25rem 0 0.5rem;">
          <span style="font-weight:800;font-size:1.6rem;color:#10243D;">PreBate</span><br/>
          <span style="color:#64748B;">Estate Readiness</span>
        </div>
    """, unsafe_allow_html=True)
...
if st.session_state.completed:
    ...
    def build_pdf():
        ...
        story = []
        # If logo found, include it; otherwise no gap
        if LOGO_PATH is not None:
            try:
