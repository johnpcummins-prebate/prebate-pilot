...
CANDIDATES = [
    Path(__file__).parent / "assets" / "prebate_logo.png",
    Path.cwd() / "assets" / "prebate_logo.png",
    Path("/mount/src/prebate-pilot/PreBate-GitHub-Ready-v2/assets/prebate_logo.png"),
    Path("/mount/src/prebate-pilot/PreBate-GitHub-Ready-v2.2/assets/prebate_logo.png"),
]

LOGO_PATH = next((p for p in CANDIDATES if p.exists()), None)

# THEME (hardcoded in CSS below)
PRIMARY = "#10243D"
SUCCESS = "#16A34A"
WARNING = "#F59E0B"
DANGER  = "#DC2626"

# CSS (hardcoded values to avoid formatting issues)
st.markdown("""
<style>
...
if st.session_state.completed:
    ...
    def build_pdf():
        ...
        story = []
        if LOGO_PATH and LOGO_PATH.exists():
            story.append(RLImage(LOGO_PATH.as_posix(), width=220, height=66))
